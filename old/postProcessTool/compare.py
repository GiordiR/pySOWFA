...
plotDir = './plot/SOWFA/'
bladeSowfa_c = SOWFA(turbineName, turbineDir, turbineFileName)
...
fast = FAST(turbineName, turbineDir, turbineFileName)
...
plotDir = './plot/SOWFA/'
bladeSowfa_f = SOWFA(turbineName, turbineDir, turbineFileName)

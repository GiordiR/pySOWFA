...
def getTitle(varName):
    titleDict = {
        ...
        "TwrBsFzt": "Tower base axial shear force",
        ...
        "TBFxExp": "Tower base fore-aft shear force",
        "TBFyExp": "Tower base side-to-side shear force",
        "TBFzExp": "Tower base axial shear force",
        "TBMxExp": "Tower base side-to-side moment",
        "TBMyExp": "Tower base fore-aft moment",
        "TBMzExp": "Tower base torsional moment",
        "TTFxExp": "Tower top fore-aft shear force",
        "TTFyExp": "Tower top side-to-side shear force",
        # SOWFA
...
def getAxes(varName):
    axesDict = {
        ...
        "TBFxExp": "Fore-aft shear force [kN]",
        "TBFyExp": "Side-to-side shear force [kN]",
        "TBFzExp": "Axial shear force [kN]",
        "TBMxExp": "Side-to-side moment [kN-m]",
        "TBMyExp": "Fore-aft moment [kN-m]",
        "TBMzExp": "Torsional moment [kN-m]",
        "TTFxExp": "Fore-aft shear force [kN]",
        "TTFyExp": "Side-to-side shear force [kN]",
        # SOWFA
